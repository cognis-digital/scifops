"""Native cognis-connect emit for scifops — forward findings to any platform.

Maps scifops's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    scifops ... --format json | scifops-emit --to stix
    scifops-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
