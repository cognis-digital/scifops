#!/usr/bin/env sh
# Universal installer for scifops. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/scifops.git"
echo "Installing scifops ..."
